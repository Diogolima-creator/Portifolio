    ...
    function typeWriter() {
        var app = document.getElementById('p-wraper')
            ...
            var typewriter = new Typewriter(app,{
                strings: ['Desenvolvedor Full-Stack 💻', 'Trabalho com React.js/Node.js 🌐','Apaixonado por tecnologia 😎'],
                autoStart: true,
                loop: true,
                delay: 45,
                pauseFor: 2000
        ...
        <C.Container>
            ...
            <div className='whoIam-header'>
                <div className='div-header'>
                    ...
                    <p className='p-wraper' id='p-wraper'><span>Desenvolvedor Full-Stack</span></p>
                    <p>Desenvolvedor Full Stack usando as tecnologias React.js e Node.js</p>
